...
public class TabProcess extends JPanel {
	...
	private JLabel [][] lblFinger = { {lblFinger1step1, lblFinger1step2, lblFinger1step3},
										{lblFinger2step1, lblFinger2step2, lblFinger2step3} };
	// Borders
	 ...
	 */
	public TabProcess(MsoDemo msoDemo) {
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(panelFinger1, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(panelFinger2, GroupLayout.PREFERRED_SIZE, 137, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
		...
		gl_panelFinger2.setHorizontalGroup(
			gl_panelFinger2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelFinger2.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblFinger2step1, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(lblFinger2step2, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(lblFinger2step3, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(32, Short.MAX_VALUE))
		);
		gl_panelFinger2.setVerticalGroup(
			gl_panelFinger2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelFinger2.createSequentialGroup()
					.addGroup(gl_panelFinger2.createParallelGroup(Alignment.LEADING)
						.addComponent(lblFinger2step1, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblFinger2step2, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblFinger2step3, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE))
					.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		);
		...
		gl_panelFinger1.setHorizontalGroup(
			gl_panelFinger1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelFinger1.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(lblFinger1step2, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(lblFinger1step3, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
						.addContainerGap(23, Short.MAX_VALUE))
		);
		gl_panelFinger1.setVerticalGroup(
			gl_panelFinger1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelFinger1.createSequentialGroup()
	...
	/**
	 * Set the live image to the appropriate Label based on fingerNumber and step
	 * 
	 * @param morphoImage
	 * @param fingerNumber
	 * @param step
	...
	public void setBorderColorGreen(short fingerNumber, short step) {
		lblFinger[fingerNumber - 1][step - 1]
				.setBorder(BorderFactory.createCompoundBorder(greenLine, lowerBevelBorder));
	}

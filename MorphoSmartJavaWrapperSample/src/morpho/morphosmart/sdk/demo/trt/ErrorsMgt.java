...
public class ErrorsMgt {
	...
	public static String getSDKErrorText(int errorCode) {
		String message = "";
			...
			case MorphoSmartSDK.MORPHOERR_MOVED_FINGER:
				message = "The finger moved during acquisition or removed earlier";
				break;
			case MorphoSmartSDK.MORPHOERR_SATURATED_FINGER:
				message = "The finger can be too shiny or too much external light";
				break;
			case MorphoSmartSDK.MORPHOERR_INVALID_FINGER:
				message = "The finger is invalid";
				break;
	...
	public static String convertSDKError(int ret) {
		...
		switch (ret) {
			...
			case MorphoSmartSDK.MORPHOERR_MOIST_FINGER:
				...
				break;
			case MorphoSmartSDK.MORPHOERR_MOVED_FINGER:
				message = "MORPHOERR_MOVED_FINGER";
				break;
			case MorphoSmartSDK.MORPHOERR_SATURATED_FINGER:
				message = "MORPHOERR_SATURATED_FINGER";
				break;
			case MorphoSmartSDK.MORPHOERR_INVALID_FINGER:
				message = "MORPHOERR_INVALID_FINGER";
				break;
			case MorphoSmartSDK.MORPHOERR_NO_SERVER:
	...
	/**
	 * Convert MSOSECU error to a readable error.
	 *
	 * @param errorCode
	 * @return
	 */
	public static String convertMSOSecuError(int ret) {
		String message = "";
		if (ret == MsoSecuConstants.MSOSECU_OK) {
			message = "MSOSECU_OK";
		} else if (ret == MsoSecuConstants.MSOSECU_BAD_PARAMETER) {
			message = "MSOSECU_BAD_PARAMETER";
		} else if (ret == MsoSecuConstants.MSOSECU_OPEN_FILE_ERR) {
			message = "MSOSECU_OPEN_FILE_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_WRITE_FILE_ERR) {
			message = "MSOSECU_WRITE_FILE_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_READ_FILE_ERR) {
			message = "MSOSECU_READ_FILE_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_DELETE_FILE_ERR) {
			message = "MSOSECU_DELETE_FILE_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_FILE_EMPTY) {
			message = "MSOSECU_FILE_EMPTY";
		} else if (ret == MsoSecuConstants.MSOSECU_CRYPTO_PROTOCOLE_ERR) {
			message = "MSOSECU_CRYPTO_PROTOCOLE_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_OPEN_SSL) {
			message = "MSOSECU_OPEN_SSL";
		} else if (ret == MsoSecuConstants.MSOSECU_INVALID_CERTIF) {
			message = "MSOSECU_INVALID_CERTIF";
		} else if (ret == MsoSecuConstants.MSOSECU_PARSE_DER_TO_X509STRUCT_ERR) {
			message = "MSOSECU_PARSE_DER_TO_X509STRUCT_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_STORE_NEW_ERR) {
			message = "MSOSECU_STORE_NEW_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_STORE_LOAD_LOCATIONS_ERR) {
			message = "MSOSECU_STORE_LOAD_LOCATIONS_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_PEM_READ_BIO_ERR) {
			message = "MSOSECU_PEM_READ_BIO_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_MODE_DSA_ERR) {
			message = "MSOSECU_MODE_DSA_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_SHA1_INIT_ERR) {
			message = "MSOSECU_SHA1_INIT_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_SHA1_UPDATE_ERR) {
			message = "MSOSECU_SHA1_UPDATE_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_SHA1_FINAL_ERR) {
			message = "MSOSECU_SHA1_FINAL_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_DSS1_INIT_ERR) {
			message = "MSOSECU_DSS1_INIT_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_DSS1_UPDATE_ERR) {
			message = "MSOSECU_DSS1_UPDATE_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_DSS1_FINAL_ERR) {
			message = "MSOSECU_DSS1_FINAL_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_BIO_NEW_MEM_ERR) {
			message = "MSOSECU_BIO_NEW_MEM_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_PARSE_DATA_TO_X509STRUCT_ERR) {
			message = "MSOSECU_PARSE_DATA_TO_X509STRUCT_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_PUBLIC_KEY_ERR) {
			message = "MSOSECU_PUBLIC_KEY_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_RSA_KEY_ERR) {
			message = "MSOSECU_RSA_KEY_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_DSA_KEY_ERR) {
			message = "MSOSECU_DSA_KEY_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_AES128_INIT_ERR) {
			message = "MSOSECU_AES128_INIT_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_AES128_UPDATE_ERR) {
			message = "MSOSECU_AES128_UPDATE_ERR";
		} else if (ret == MsoSecuConstants.MSOSECU_AES128_FINAL_ERR) {
			message = "MSOSECU_AES128_FINAL_ERR";
		} else  {
